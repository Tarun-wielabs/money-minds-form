...
export default function page() {
  return (
    <div className="min-h-screen bg-[url('/Gradient3.png')] bg-contain bg-bottom bg-no-repeat w-full flex items-center justify-center md:p-10 p-5">
      <div className="from-[#DBDBFF99] to-[#2A3439]  bg-transparent p-[1.5px] rounded-[24px]">
        <div className="flex flex-col items-center rounded-[24px] justify-evenly md:gap-10 gap-5  w-full md:px-10 px-0 py-10 bg-transparent">
          <span
