...
export default function page() {
  return (
    <div className="min-h-screen bg-[url('/Gradient3.png')] bg-contain bg-bottom bg-no-repeat w-full flex items-center justify-center md:p-10 p-5">
      <div className="flex flex-col items-center border border-[#2A3439] rounded-[24px] justify-evenly gap-10 lg:w-[800px] md:w-[650px] w-full md:px-10 px-5 py-10 bg-custom-gradient">
        <span
